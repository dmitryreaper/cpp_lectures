...
1.  [1. Перечислите и охарактеризуйте стадии разработки программного обеспечения](#org139d2ea)
    1.  [Анализ требований:](#org7ad275e)
    2.  [Проектирование (дизайн):](#org873cd83)
    3.  [Реализация (кодирование):](#orgcb20251)
    4.  [Тестирование:](#orgfa99bdf)
    5.  [Интеграция и деплоймент:](#org3c5f07a)
    6.  [Эксплуатация и сопровождение:](#orgb7a9465)
    7.  [Завершение проекта:](#org95ae115)
2.  [2. Раскройте понятие алгоритм, перечислите и охарактеризуйте свойства алгоритмов](#org86c9d96)
    1.  [Свойства алгоритмов:](#org0a412ce)
    2.  [Примеры некоторых алгоритмов из STL в C++:](#orgad4976f)
3.  [3. Раскройте понятие алгоритм, перечислите и охарактеризуйте способы описания алгоритмов](#org1d72171)
        1.  [Способы описания алгоритмов на примере C++:](#org907afbc)
4.  [4. Раскройте понятие алгоритм, перечислите и охарактеризуйте виды алгоритмов](#org07291f2)
        1.  [Виды алгоритмов и их характеристика:](#org1de32a1)
5.  [5. Раскройте понятие тип данных, перечислите основные встроенные типы данных](#orge51549c)
        1.  [Основные встроенные типы данных в C++](#org5a71480)
        2.  [Примеры использования основных типов данных в C++](#orgf0c493e)
6.  [6. Перечислите и охарактеризуйте основные структурные элементы программы](#orga0b7591)
        1.  [Заголовочные файлы](#org6424be3)
        2.  [Пространства имен (namespaces)](#org11b72cc)
        3.  [Функции](#orgf9a8038)
        4.  [Переменные](#orge20705a)
        5.  [Операторы](#org0174c03)
        6.  [Управляющие структуры](#org421e7b7)
        7.  [Классы и объекты](#orgd79af2d)
        8.  [Комментарии](#orgd363c21)
        9.  [Константы](#orgdc53e78)
        10. [Предпроцессорные директивы](#org6fcf2e7)
7.  [7. Раскройте понятие оператор, перечислите и охарактеризуйте виды операторов](#org793719f)
        1.  [Понятие оператора](#orgfc53448)
        2.  [Виды операторов и их характеристика](#orge6aa556)
8.  [8. Перечислите и приведите примеры операторов организации циклов](#org92066ab)
        1.  [Цикл for](#org913497b)
        2.  [Цикл while](#orgcfc537e)
        3.  [Цикл do while](#org8d8e379)
        4.  [Операторы управления циклами](#org2cf56ca)
9.  [9. Перечислите и приведите примеры условных операторов](#org93cc0ed)
10. [10. Раскройте понятие итерационный алгоритм, охарактеризуйте порядок выполнения](#org9bfb424)
        1.  [Порядок выполнения итерационного алгоритма:](#org4514480)
11. [11. Раскройте понятие массив, перечислите виды массивов, приведите примеры описания одномерных массивов](#org2429255)
        1.  [Примеры описания одномерных массивов на C++](#org8059dee)
12. [12. Раскройте понятие массив, перечислите виды массивов, приведите примеры описания массивов массивов](#org3325085)
        1.  [Примеры описания массивов массивов (двумерных массивов) на C++:](#orgbbb78c2)
13. [13. Раскройте понятие процедура и функция, перечислите ключевые особенности](#orgfdce310)
14. [14. Раскройте понятие процедура и функция, приведите классификацию параметров](#org213d90b)
        1.  [1. По направлению передачи данных:](#orgd5dd593)
        2.  [2. По типу передачи:](#org5789c94)
        3.  [3. По наличию значений по умолчанию:](#org11cf6a6)
15. [15. Раскройте суть метода пошаговой детализации разработки алгоритмов](#org0272cfd)
        1.  [Основные шаги метода пошаговой детализации](#org0694bc4)
        2.  [Пример применения метода пошаговой детализации на C++:](#org6728983)
        3.  [Преимущества метода пошаговой детализации:](#org03b3933)
16. [16. Раскройте понятие строка и символьная переменная, приведите примеры объявлений](#orgf554b8b)
        1.  [Строка](#orgb847bd4)
        2.  [Символьная переменная](#orga17fc17)
17. [17. Перечислите основные функции обработки строк, приведите пример использования](#orgf8e9385)
        1.  [Основные функции и методы обработки строк:](#orgdbf1cd7)
        2.  [Пример использования основных функций обработки строк:](#orgd7cf6ab)
18. [18. Раскройте понятие множество, перечислите операции над множествами](#org001f0f2)
    1.  [Основные операции над множествами](#org5739a49)
    2.  [Пример использования операций над множествами на C++](#org954496a)
19. [19. Раскройте понятие множество, перечислите ключевые особенности множества и мультимножества](#org23a3580)
    1.  [Множество](#org8588169)
    2.  [Мультимножество](#orga92999a)
20. [20. Раскройте понятие строка, перечислите основные операции над строками](#org90f51b8)
        1.  [Строка](#orgcc1b001)
21. [21. Раскройте понятие сортировка, перечислите виды сортировок.](#orgb0240af)
    1.  [Понятие сортировка](#orge7f2c74)
    2.  [Виды сортировок](#org58b0612)
    3.  [Краткое описание и примеры алгоритмов сортировки](#org2ca1637)
        1.  [1. Пузырьковая сортировка (Bubble Sort)](#orgf906612)
        2.  [2. Сортировка вставками (Insertion Sort)](#org2addad8)
        3.  [3. Сортировка выбором (Selection Sort)](#org2b54ed0)
        4.  [4. Сортировка слиянием (Merge Sort)](#orgdf8632f)
22. [22. Охарактеризуйте сортировку обменом, перечислите основные алгоритмы обменных сортировок](#orgdb2fde7)
    1.  [Сортировка обменом](#orge79a721)
    2.  [Основные алгоритмы обменных сортировок](#orga9924c8)
        1.  [1. Пузырьковая сортировка (Bubble Sort)](#org075f269)
        2.  [2. Шейкерная сортировка (Cocktail Shaker Sort)](#orga257690)
        3.  [3. Сортировка Шелла (Shell Sort)](#org2d0b7e3)
        4.  [4. Быстрая сортировка (Quick Sort)](#org392e763)
23. [23. Охарактеризуйте сортировку вставками, перечислите основные алгоритмы сортировоквставками](#orgc4a4c2c)
24. [24. Охарактеризуйте сортировку выбором, перечислите основные алгоритмы сортировок выбором](#orgdafb573)
25. [25. Раскройте понятие структура, приведите пример описания](#org2a4848a)
26. [26. Раскройте понятие структура, приведите пример обращения к элементам структуры](#org54adc6e)
27. [27. Раскройте понятие объединение, приведите пример описания](#orgbb608db)
28. [28. Раскройте понятие объединение, перечислите ключевые отличия от структуры](#org0970dbf)
29. [29. Раскройте понятие перечисление, приведите пример объявления](#orgd5f4d39)
30. [30. Раскройте понятие файл, перечислите и охарактеризуйте виды файлов](#orgfefe915)
31. [31. Раскройте понятие файл, перечислите и охарактеризуйте способы доступа к файлам](#org1488600)
32. [32. Раскройте понятие файл, приведите пример объявления файловой переменной](#org9f88184)
33. [33. Раскройте понятия рекурсия, шаг рекурсии](#orgb115d07)
34. [34. Раскройте понятие рекурсия, перечислите виды рекурсивных функций](#org9fb2169)
35. [35. Раскройте понятие рекурсия, перечислите ключевые особенности объявления и использования рекурсивных функций](#org2557626)
36. [36. Раскройте понятие объектно-ориентированное программирование, перечислите основные свойства ООП](#org3a8a7ca)
37. [37. Перечислите и охарактеризуйте основные свойства ООП](#org75f9d64)
38. [38. Раскройте понятие класс, приведите пример объявления, охарактеризуйте основные элементы](#org6687b55)
39. [39. Раскройте понятие класс, приведите пример объявления объектов класса и обращения к элементам класса](#org76f607b)
40. [40. Раскройте понятие объект, класс, конструктор, деструктор](#orga41176c)
41. [41. Раскройте понятие наследование, приведите пример наследования классов](#orge4b6702)
42. [42. Охарактеризуйте особенности вызова и передачи аргументов конструктора и деструктора при наследовании](#orga03e3e6)
43. [43. Охарактеризуйте понятие динамическая библиотека, назначение и использование](#org1a1e419)
44. [44. Раскройте понятие динамические структуры данных, их назначение и использование](#org3f2bd6a)
45. [45. Перечислите динамические структуры данных, охарактеризуйте структуру стек](#org96fe5bf)
46. [46. Перечислите динамические структуры данных, охарактеризуйте структуру односвязный список](#org5f02a51)
47. [47. Перечислите динамические структуры данных, охарактеризуйте структуру двусвязный список](#org257a86c)
48. [48. Перечислите динамические структуры данных, охарактеризуйте структуру очередь](#org668baa6)
49. [49. Перечислите динамические структуры данных, охарактеризуйте структуру двоичное дерево](#orgac693f9)
50. [50. Перечислите способы обхода деревьев](#org6ff9bf1)
51. [51. Перечислите динамические структуры данных, охарактеризуйте структуру кольцо](#org94845ca)
52. [52. Раскройте понятие хеширование, перечислите функции хеширования](#org1c72b4d)
53. [53. Перечислите и охарактеризуйте способы разрешения конфликтов при хешировании](#org3642e04)
54. [54. Перечислите методы и способы создания анимации в среде программирования](#orge813198)
55. [55. Раскройте понятие windows-приложение. Назовите стандартные компоненты для разработки приложений](#org0ec6b8b)
56. [56. Раскройте понятие пространство имен, его назначение.](#orgf1dbda4)
57. [57. Раскройте понятие заголовочный файл, его назначение и использование](#org75eea74)
58. [58. Раскройте понятие двоичное дерево, балансировка двоичного дерева](#org3a0a754)
59. [59. Раскройте понятие класс, объект, перечислите спецификаторы доступа](#org199a76d)
60. [60. Раскройте понятие массив, особенности передачи массивов в качестве параметров](#org5426f7e)
61. [61. Раскройте понятие тестирование программного обеспечения. Перечислите и кратко охарактеризуйте основные эпохи тестирования](#org260b30d)
62. [62. Раскройте понятие тестирование программного обеспечения. Приведите упрощенную классификацию тестирования](#orge0964c2)
63. [63. Раскройте понятие тестирование программного обеспечения. Перечислите и охарактеризуйте виды тестирования по запуску кода на исполнение](#orgb5f6298)
64. [64. Раскройте понятие тестирование программного обеспечения. Перечислите и охарактеризуйте виды тестирования по доступу к коду и архитектуре приложения](#orga9edbae)
65. [65. Раскройте понятие тестирование программного обеспечения. Перечислите и охарактеризуйте виды тестирования по степени автоматизации](#org126f22c)
66. [66. Раскройте понятие тестирование программного обеспечения. Перечислите и охарактеризуйте виды тестирования по принципам работы с приложением](#org4bb1b4f)
