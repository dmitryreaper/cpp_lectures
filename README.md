...
1.  [1. Перечислите и охарактеризуйте стадии разработки программного обеспечения](#org91aa8ca)
    1.  [Анализ требований:](#org0830292)
    2.  [Проектирование (дизайн):](#orge712bf0)
    3.  [Реализация (кодирование):](#org7b9b43a)
    4.  [Тестирование:](#org93d9921)
    5.  [Интеграция и деплоймент:](#org83785c5)
    6.  [Эксплуатация и сопровождение:](#orgfa57e11)
    7.  [Завершение проекта:](#orgbf9e7d0)
2.  [2. Раскройте понятие алгоритм, перечислите и охарактеризуйте свойства алгоритмов](#orgb73c386)
    1.  [Свойства алгоритмов:](#org2a43574)
    2.  [Примеры некоторых алгоритмов из STL в C++:](#orgf4b0a22)
3.  [3. Раскройте понятие алгоритм, перечислите и охарактеризуйте способы описания алгоритмов](#org0a733ad)
    1.  [Способы описания алгоритмов на примере C++:](#orgabaa079)
4.  [4. Раскройте понятие алгоритм, перечислите и охарактеризуйте виды алгоритмов](#orgb3a2250)
    1.  [Виды алгоритмов и их характеристика:](#org23cf683)
5.  [5. Раскройте понятие тип данных, перечислите основные встроенные типы данных](#orgbeb3188)
    1.  [Основные встроенные типы данных в C++](#org0cf15c8)
        1.  [Примеры использования основных типов данных в C++](#org9baa33c)
6.  [6. Перечислите и охарактеризуйте основные структурные элементы программы](#orgd07a0bc)
    1.  [Заголовочные файлы](#org611bec6)
    2.  [Пространства имен (namespaces)](#org768d661)
    3.  [Функции](#org8ae452a)
    4.  [Переменные](#org12b3073)
    5.  [Операторы](#org7a0596f)
    6.  [Управляющие структуры](#org1d7fcf9)
    7.  [Классы и объекты](#org732df3b)
    8.  [Комментарии](#orgdd17929)
    9.  [Константы](#org550fc97)
    10. [Предпроцессорные директивы](#org575762a)
7.  [7. Раскройте понятие оператор, перечислите и охарактеризуйте виды операторов](#org736e7ff)
    1.  [Понятие оператора](#orgb32cc75)
    2.  [Виды операторов и их характеристика](#org672e423)
8.  [8. Перечислите и приведите примеры операторов организации циклов](#org7b43598)
    1.  [Цикл for](#org6342bfd)
    2.  [Цикл while](#org86258ab)
    3.  [Цикл do while](#orga9f48b6)
    4.  [Операторы управления циклами](#org258b00c)
9.  [9. Перечислите и приведите примеры условных операторов](#org521ffbe)
10. [10. Раскройте понятие итерационный алгоритм, охарактеризуйте порядок выполнения](#org478ac51)
    1.  [Порядок выполнения итерационного алгоритма:](#orgb6f19d3)
11. [11. Раскройте понятие массив, перечислите виды массивов, приведите примеры описания одномерных массивов](#orge767029)
    1.  [Примеры описания одномерных массивов на C++](#org11a3a60)
12. [12. Раскройте понятие массив, перечислите виды массивов, приведите примеры описания массивов массивов](#orgb1b701f)
    1.  [Примеры описания массивов массивов (двумерных массивов) на C++:](#org2f0e6d5)
13. [13. Раскройте понятие процедура и функция, перечислите ключевые особенности](#org23461ac)
14. [14. Раскройте понятие процедура и функция, приведите классификацию параметров](#org4cdb2c7)
    1.  [1. По направлению передачи данных:](#orge7842fd)
    2.  [2. По типу передачи:](#org4c42df8)
    3.  [3. По наличию значений по умолчанию:](#orgebcfeea)
15. [15. Раскройте суть метода пошаговой детализации разработки алгоритмов](#org6df9138)
    1.  [Основные шаги метода пошаговой детализации](#org126a710)
    2.  [Пример применения метода пошаговой детализации на C++:](#org618f7f7)
    3.  [Преимущества метода пошаговой детализации:](#org04543d5)
16. [16. Раскройте понятие строка и символьная переменная, приведите примеры объявлений](#org67dcd55)
    1.  [Строка](#orgc00fe29)
    2.  [Символьная переменная](#orgfdeb1a6)
17. [17. Перечислите основные функции обработки строк, приведите пример использования](#org1fcbf48)
    1.  [Основные функции и методы обработки строк:](#org961df55)
    2.  [Пример использования основных функций обработки строк:](#orgdb7b32f)
18. [18. Раскройте понятие множество, перечислите операции над множествами](#orgdc6c832)
    1.  [Основные операции над множествами](#orgd0033c0)
    2.  [Пример использования операций над множествами на C++](#orgc525505)
19. [19. Раскройте понятие множество, перечислите ключевые особенности множества и мультимножества](#org3886e86)
    1.  [Множество](#org6c715be)
    2.  [Мультимножество](#org096bace)
20. [20. Раскройте понятие строка, перечислите основные операции над строками](#orgc16189a)
    1.  [Строка](#org972cf47)
21. [21. Раскройте понятие сортировка, перечислите виды сортировок.](#orgdad7159)
    1.  [Понятие сортировка](#org4c417df)
    2.  [Виды сортировок](#orga0ea8d4)
    3.  [Краткое описание и примеры алгоритмов сортировки](#org862081e)
        1.  [1. Пузырьковая сортировка (Bubble Sort)](#org9a60154)
        2.  [2. Сортировка вставками (Insertion Sort)](#org89547df)
        3.  [3. Сортировка выбором (Selection Sort)](#org8b16121)
        4.  [4. Сортировка слиянием (Merge Sort)](#orgb2448c9)
22. [22. Охарактеризуйте сортировку обменом, перечислите основные алгоритмы обменных сортировок](#orgfa8a471)
    1.  [Сортировка обменом](#org989a7cb)
    2.  [Основные алгоритмы обменных сортировок](#org309c802)
        1.  [1. Пузырьковая сортировка (Bubble Sort)](#orgdfa2621)
        2.  [2. Шейкерная сортировка (Cocktail Shaker Sort)](#org31dee8e)
        3.  [3. Сортировка Шелла (Shell Sort)](#orgc816911)
        4.  [4. Быстрая сортировка (Quick Sort)](#org664b587)
23. [23. Охарактеризуйте сортировку вставками, перечислите основные алгоритмы сортировоквставками](#org8c5d87f)
24. [24. Охарактеризуйте сортировку выбором, перечислите основные алгоритмы сортировок выбором](#org1f95fdc)
25. [25. Раскройте понятие структура, приведите пример описания](#orgb60886d)
26. [26. Раскройте понятие структура, приведите пример обращения к элементам структуры](#org30a0881)
27. [27. Раскройте понятие объединение, приведите пример описания](#orgbe99f9a)
28. [28. Раскройте понятие объединение, перечислите ключевые отличия от структуры](#org72bdc7e)
29. [29. Раскройте понятие перечисление, приведите пример объявления](#orgebafaf5)
30. [30. Раскройте понятие файл, перечислите и охарактеризуйте виды файлов](#org365f2d2)
31. [31. Раскройте понятие файл, перечислите и охарактеризуйте способы доступа к файлам](#org4efb67d)
32. [32. Раскройте понятие файл, приведите пример объявления файловой переменной](#orgf81bcca)
33. [33. Раскройте понятия рекурсия, шаг рекурсии](#org0b02512)
34. [34. Раскройте понятие рекурсия, перечислите виды рекурсивных функций](#org9c82370)
35. [35. Раскройте понятие рекурсия, перечислите ключевые особенности объявления и использования рекурсивных функций](#org11aeab1)
36. [36. Раскройте понятие объектно-ориентированное программирование, перечислите основные свойства ООП](#org9c9c9d3)
37. [37. Перечислите и охарактеризуйте основные свойства ООП](#orgc7e169e)
38. [38. Раскройте понятие класс, приведите пример объявления, охарактеризуйте основные элементы](#orgf1ca36d)
39. [39. Раскройте понятие класс, приведите пример объявления объектов класса и обращения к элементам класса](#orga762ae8)
40. [40. Раскройте понятие объект, класс, конструктор, деструктор](#org0c45d8a)
41. [41. Раскройте понятие наследование, приведите пример наследования классов](#org5403500)
42. [42. Охарактеризуйте особенности вызова и передачи аргументов конструктора и деструктора при наследовании](#org49ca729)
43. [43. Охарактеризуйте понятие динамическая библиотека, назначение и использование](#org5c15563)
44. [44. Раскройте понятие динамические структуры данных, их назначение и использование](#org04cf957)
45. [45. Перечислите динамические структуры данных, охарактеризуйте структуру стек](#org392d7b2)
46. [46. Перечислите динамические структуры данных, охарактеризуйте структуру односвязный список](#org6df1180)
47. [47. Перечислите динамические структуры данных, охарактеризуйте структуру двусвязный список](#org715633d)
48. [48. Перечислите динамические структуры данных, охарактеризуйте структуру очередь](#org3f7f1cb)
49. [49. Перечислите динамические структуры данных, охарактеризуйте структуру двоичное дерево](#org8411086)
50. [50. Перечислите способы обхода деревьев](#orgc359663)
51. [51. Перечислите динамические структуры данных, охарактеризуйте структуру кольцо](#orgdc30529)
52. [52. Раскройте понятие хеширование, перечислите функции хеширования](#org97d16e6)
53. [53. Перечислите и охарактеризуйте способы разрешения конфликтов при хешировании](#org519c14d)
54. [54. Перечислите методы и способы создания анимации в среде программирования](#orgf77406b)
55. [55. Раскройте понятие windows-приложение. Назовите стандартные компоненты для разработки приложений](#orgdbf9fcd)
56. [56. Раскройте понятие пространство имен, его назначение.](#orga97860d)
57. [57. Раскройте понятие заголовочный файл, его назначение и использование](#org08875ff)
58. [58. Раскройте понятие двоичное дерево, балансировка двоичного дерева](#orgb572b46)
59. [59. Раскройте понятие класс, объект, перечислите спецификаторы доступа](#org28a10c2)
60. [60. Раскройте понятие массив, особенности передачи массивов в качестве параметров](#org89f31cd)
61. [61. Раскройте понятие тестирование программного обеспечения. Перечислите и кратко охарактеризуйте основные эпохи тестирования](#org8c7da11)
62. [62. Раскройте понятие тестирование программного обеспечения. Приведите упрощенную классификацию тестирования](#org88b4bca)
63. [63. Раскройте понятие тестирование программного обеспечения. Перечислите и охарактеризуйте виды тестирования по запуску кода на исполнение](#org19fbbb1)
64. [64. Раскройте понятие тестирование программного обеспечения. Перечислите и охарактеризуйте виды тестирования по доступу к коду и архитектуре приложения](#orgf98111f)
65. [65. Раскройте понятие тестирование программного обеспечения. Перечислите и охарактеризуйте виды тестирования по степени автоматизации](#org6ac4274)
66. [66. Раскройте понятие тестирование программного обеспечения. Перечислите и охарактеризуйте виды тестирования по принципам работы с приложением](#org667b60f)
